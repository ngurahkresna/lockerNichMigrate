  ...
  <head>
    ...
    <title>Landing Page</title>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="pendidikan" id="pendidikan" placeholder="Pendidikan Terakihir">
        </div>
        <div class="form-group">
            <label for="bidang"></label>
            <input type="text" class="form-control" name="bidang" id="bidang" placeholder="Bidang Yang Diinginkan">
        </div>
        <div class="form-group">
            <label for="lokasi"></label>
            <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Yang Diinginkan">
        </div>
        <div class="form-group">
